export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wx0551d83307852cd8",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: " f140c8f7fc83412bf45610c46c2ab5ab ",
   ...
   *    id: "oBAL5544WJShh5x283454j-lmj0E",
   *    // 你想对他发送的模板消息的模板ID
   ...
   */
  FESTIVALS: [
    {"type": "生日", "name": "思思宝贝", "year": "2001", "date": "08-07"},
    {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "01-17"},
  ],
